...
class CTCLossOCR(CTCLoss):
    ...
    def forward(self, log_probs: torch.Tensor,
        ...
        Args:
            ...
            targets (torch.tensor): Target. Consist of target and
                CTC length data.
